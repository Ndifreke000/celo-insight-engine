    ...
    <section id="solution" className="py-16 sm:py-24 lg:py-32 relative bg-secondary/20">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mx-auto mb-12 sm:mb-16">
          {/* Engine A */}
          <div className="group p-6 sm:p-8 rounded-2xl bg-card border border-border/50 hover:border-primary/50 transition-all duration-300">
          ...
          {/* Engine B */}
          <div className="group p-6 sm:p-8 rounded-2xl bg-card border border-border/50 hover:border-accent/50 transition-all duration-300">
            <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
        ...
        <div className="max-w-5xl mx-auto px-4">
          <h3 className="text-xl sm:text-2xl font-bold text-center mb-8 sm:mb-12">The Workflow</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <div key={index} className="relative">
                <div className="p-4 sm:p-6 rounded-xl bg-card border border-border/50 text-center h-full">
